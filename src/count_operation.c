...
/*   Updated: 2024/01/18 17:32:38 by emauduit         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	count_to_find_cheapest(t_list **stack_a, t_list **stack_b, int content,
		int target)
{
	t_data count;
	...
	final_count(&count);
    count.count = count.rra + count.rrb + count.ra + count.rb + count.rr + count.rrr;
	return (count.count);
}
